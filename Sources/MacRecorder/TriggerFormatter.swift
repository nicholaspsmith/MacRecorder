...
/// Renders a `Trigger` as a glyph string for the menu and prefs UI, e.g. "⌘⇧5".
/// Adapted from KeyLight; MacRecorder only uses standard-key triggers, but the
/// media-key case is handled for completeness.
